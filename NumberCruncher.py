...
def MC_Scaler(htbin,jetmult,mc_yield,sample = '',error = '',Analysis = '',btagbin = ''):
    ...
    if Analysis == "8TeV":
        ...
        AlphaT_Scale = {"200_1":0.84,"200_2":0.78, "200_3":0.72, "200_4":0.72, #200_4 is nan, so assume same as 200_3
        ...
        AlphaT_Error = {"200_1":0.01,  "200_2":0.01,  "200_3":0.04,  "200_4":0.04,
                        "275_1":0.01,  "275_2":0.01,  "275_3":0.01,  "275_4":0.08,
                        "325_1":0.01,  "325_2":0.01,  "325_3":0.01,  "325_4":0.06,
                        "375_1":0.01,  "375_2":0.02,  "375_3":0.01,  "375_4":0.05,
                        "475_1":0.01,  "475_2":0.02,  "475_3":0.005,  "475_4":0.02,
        ...
        Muon_Scale = {"150_1": 0.872,"150_2": 0.872,"150_3": 0.881,"150_4": 0.881,
        ...
        DiMuon_Scale = {"150_1": 0.984, "150_2": 0.984, "150_3": 0.984, "150_4": 0.984,
    ...
    if [False, True][1]:
      ...
      for dict in [AlphaT_Scale, Muon_Scale, DiMuon_Scale][:1]:
        for key in dict:
          if key.split("_")[0] in ["150", "200", "275", "325"]:
            continue
          dict[key] = 1.0
