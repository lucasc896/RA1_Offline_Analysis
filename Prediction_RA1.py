...
settings = {
    ...
    "plots":["AlphaT_","HT_QCD_"][:1],  # Histogram that Yields are taken from
    "AlphaTSlices":["0.55_50", "0.56_50", "0.57_50", "0.58_50", "0.59_50", "0.60_50", "0.53_50", "0.53_0.55", "0.55_0.60", "0.60_0.70", "0.507_50"][-1:], # AlphaT Slices, WARNING: this fucks up Formula Method!!
